# I added functionality to compute the molar mass of a compound and calculate the number of moles in a sample.
...
def get_atomic_mass(symbol, periodic_table):
...
def compute_molar_mass(formula, periodic_table):
    ...
    for symbol, count_str in pattern:
        count = int(count_str) if count_str else 1
        atomic_mass = get_atomic_mass(symbol, periodic_table)
